    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-slate-50 to-indigo-100 py-2 md:py-4 px-4 md:px-10 font-sans text-slate-800 flex flex-col items-center">
            <div className="max-w-4xl w-full space-y-3">
                <header className="text-center space-y-0.5 relative">
                    <PageTitle className="flex items-center justify-center gap-2 !text-xl md:!text-2xl">
                        <Sparkles className="w-5 h-5 md:w-6 md:h-6 text-indigo-500" />
                        Domain Appraisal
                    </PageTitle>
                    <p className="text-[13px] text-slate-500 font-normal max-w-2xl mx-auto leading-tight">
                        Real-time market valuation using AI.
                    </p>
                    <div className="pt-0">
                        <Link href="/bulk-appraisal" className="inline-flex items-center gap-1 text-[10px] font-bold text-indigo-500 hover:text-indigo-600 transition-colors uppercase tracking-wider">
                            Bulk Appraisal <ArrowRight className="w-2.5 h-2.5" />
                        </Link>
                    </div>
                </header>
                ...
                <div className="bg-white/90 backdrop-blur-xl rounded-2xl shadow-xl border border-white/50 p-3">
                    <form onSubmit={handleSubmit} className="flex flex-col md:flex-row gap-2">
                        ...
                        <button
                            ...
                            className="px-6 py-2 bg-indigo-600 hover:bg-indigo-700 disabled:bg-slate-300 disabled:cursor-not-allowed text-white text-base font-semibold rounded-xl shadow-lg shadow-indigo-200 transition-all active:scale-95 flex items-center justify-center gap-2 min-w-[150px] h-11 self-start mt-0 md:mt-0"
                        >
                            {isFormLoading ? (
                                <>
                ...
                {(result || availability || availabilityError) && (
                    <div className="grid md:grid-cols-2 gap-3 animate-in fade-in slide-in-from-bottom-4">
                        ...
                        {result && (
                            <div className="bg-white/90 backdrop-blur-xl rounded-2xl shadow-xl border border-indigo-100 p-4 md:col-span-2 flex flex-col md:flex-row items-center justify-between gap-4 relative overflow-hidden">
                                ...
                                <div className="space-y-1 text-center md:text-left z-10 w-full md:w-auto">
                                    <h3 className="text-slate-500 font-semibold uppercase tracking-wider text-[10px] flex items-center gap-2 justify-center md:justify-start">
                        ...
                        {/* Methodology Card */}
                        <div className="md:col-span-2 bg-gradient-r from-slate-800 to-slate-900 rounded-2xl p-5 text-white shadow-2xl relative overflow-hidden group">
                            ...
                            <h4 className="text-indigo-400 font-bold uppercase tracking-[0.2em] text-[10px] mb-4 flex items-center gap-3">
                                <span className="w-6 h-px bg-indigo-400/30" />
                                How we value domains
                            </h4>
                            <div className="grid md:grid-cols-3 gap-6">
                                <div className="space-y-1.5">
                                    <div className="p-1.5 w-8 h-8 bg-white/5 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform">
                ...
                <div className="mt-6 pt-4 border-t border-slate-200/60 text-center animate-in fade-in duration-700">
                    <p className="text-[10px] text-slate-400 leading-relaxed max-w-2xl mx-auto px-4 font-normal uppercase tracking-wide">
            ...
            <footer className="mt-auto py-6 text-slate-400 text-[10px] font-medium">
