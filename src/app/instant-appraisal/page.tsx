        ...
        <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-slate-50 to-indigo-100 py-2 md:py-4 px-4 md:px-10 font-sans text-slate-800 flex flex-col items-center">
            <div className="max-w-4xl w-full space-y-3">
                <header className="text-center space-y-1 relative">
                    ...
                    <div className="pt-1">
                        <Link href="/bulk-appraisal" className="inline-flex items-center gap-1 text-xs font-bold text-indigo-500 hover:text-indigo-600 transition-colors uppercase tracking-wider">
                                        ...
                                        <div className="flex items-center gap-3 mb-1">
                                            ...
                                            <div className="flex gap-1.5">
                                                {(availability.rawStatuses?.some(s => ['marketed', 'priced', 'premium', 'transferable'].includes(s))) && (
                                                    <span className="px-2 py-0.5 bg-indigo-600 text-white text-xs font-bold rounded-md uppercase tracking-wider">
                                                        Premium
                                                    </span>
                                                )}
                                                {(availability.rawStatuses?.includes('parked') || availability.status?.toLowerCase().includes('parked')) && (
                                                    <span className="px-2 py-0.5 bg-amber-500 text-white text-xs font-bold rounded-md uppercase tracking-wider">
                                                        Parked
                                                    </span>
                                                )}
                                            </div>
